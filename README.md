...
probes:
  - id: extract-json
    prompt: "Extract invoice fields from: 'Invoice #1234, total $99.00, due 2026-07-01'"
    assertions:
      - "output.is_valid_json()"
      - "output.contains(\"invoice_number\")"
  - id: tone-formal
    prompt: "Reply to this complaint professionally: 'Your service is terrible.'"
    assertions:
      - "output.min_length(20)"
```
